from dz_dynamodb.sync_strategies import full_table, log_based
from dz_dynamodb import discover, dynamodb
import dz_dynamodb
import unittest
...
class TestBackoffError(unittest.TestCase):
    ...
    '''
    @mock.patch('dz_dynamodb.dynamodb.get_client',side_effect=mock_get_client)
    ...
    @mock.patch('dz_dynamodb.dynamodb.get_client',side_effect=mock_get_client)
    @mock.patch('dz_dynamodb.dynamodb.get_stream_client',side_effect=mock_get_client)
    ...
    @mock.patch('dz_dynamodb.dynamodb.get_client',side_effect=mock_get_client_connect_timeout)
    ...
    @mock.patch('dz_dynamodb.dynamodb.get_client',side_effect=mock_get_client_connect_timeout)
    @mock.patch('dz_dynamodb.dynamodb.get_stream_client',side_effect=mock_get_client_connect_timeout)
...
class TestRequestTimeoutValue(unittest.TestCase):
    ...
    @mock.patch("dz_dynamodb.dynamodb.Config")
