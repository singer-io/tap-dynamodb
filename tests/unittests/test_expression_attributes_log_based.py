...
from dz_dynamodb.sync_strategies.log_based import sync, prepare_projection
...
@patch('dz_dynamodb.dynamodb.get_client', return_value = client)
@patch('dz_dynamodb.dynamodb.get_stream_client', return_value = client)
class TestExpressionAttributesInLogBasedSync(unittest.TestCase):
    ...
    @patch('dz_dynamodb.sync_strategies.log_based.sync_shard', return_value = 1)
    @patch('dz_dynamodb.deserialize.Deserializer', return_value = {})
    ...
    @patch('dz_dynamodb.sync_strategies.log_based.prepare_projection', return_value = 1)
    ...
    @patch('dz_dynamodb.sync_strategies.log_based.sync_shard', return_value = 1)
    @patch('dz_dynamodb.sync.clear_state_on_replication_change')
